...
public class GestorAlumnos {
    ...
    public void generarFicheroCSV(List<Alumno> alumnos, String filename) throws IOException {
    ...
    public List<Alumno> cargarFicheroCSV(String filename)  {
        try (BufferedReader reader = new BufferedReader(new FileReader(filename))) {
            ...
            throw new RuntimeException("El fichero que quiere cargar no existe.");
        }
    }

    public long generarFicheroSerializable(String filename) {
    long length = 0;
    ...
    public List<Alumno> cargarFicheroSerializable(String filename) {
    ...
    public long lineasFicheroCSV(String path) throws IOException {
        long lineCount = 0;
    ...
    public long pesoFicheroSerializable(String path) throws IOException {
        long peso = 0;
